...
<figure>
<img src="4.1.png" alt="图4.1：Lennard-Jones相互作用" />
...
<figure>
<img src="4.2.png" alt="图4.2：Buckingham相互作用" />
...
<figure>
<img src="4.3.png" alt="图4.3：反应场与非反应场的库仑相互作用（带同种电荷的粒子之间）。在非反应场的情况下 $\ve_r$ 为1， $\ve_{rf}$ 为78， $r_c$ 为0.9纳米。除相差一个常数外，点划线与虚线完全相同。" />
...
<figure>
<img src="4.4.png" alt="图4.4：库仑力，移位力与移位函数 $S(r)$, 其中 $r_1=2, r_c=4$. " />
...
<figure>
<img src="4.5.png" alt="图4.5：键伸缩的原理（左）以及键伸缩的势能（右）。" />
...
<figure>
<img src="4.6.png" alt="图4.6：Morse势阱，键长为0.15nm。" />
...
<figure>
<img src="4.7.png" alt="图4.7：角振动原理（左）和键角势（右）。" />
...
<figure>
<img src="4.8.png" alt="图4.8：弯曲键角势：余弦简谐（黑实线），简谐角（虚黑线）和限制弯曲（红色），三者具有相同的弯曲常数 $k_{\theta} = 85 \text{kJ mol}^{-1}$ 和平衡角 $\theta_0 = 130^{\circ}$ 。橙色线表示余弦简谐($k = 50 \text{kJ mol}^{-1}$)与限制弯曲($k = 25 \text{kJ mol}^{-1}$)的和，二者的 $\theta_0 = 130^{\circ}$ 。" />
...
<figure>
<img src="4.9.png" alt="图4.9：异常二面角原理。环的面外弯曲（左），环的取代（中），四面体偏离（右）。在所有情况下，异常二面角 $\x$ 被定义为平面 $(i,j,k)$ 和 $(j,k,l)$ 之间的夹角。" />
...
<figure>
<img src="4.10.png" alt="图4.10：异常二面角的势能" />
...
<figure>
<img src="4.11.png" alt="图4.11：正常二面角的原理（左，反式trans构型）和二面角势（右）" />
...
<figure>
<img src="4.12.png" alt="图4.12：Ryckaert-Bellemans二面角势" />
...
<figure>
<img src="4.13.png" alt="图4.13：蓝色：组合弯曲扭转势的表面图(方程4.69，其中 $k=10 \text{kJ mol}^{-1},a_0 = 2.41, a_1 = -2.95, a_2 = 0.36, a_3 = 1.33$)，为简单起见，弯曲角相同($\theta_1=\theta_2=\theta$)。灰色：同样的扭转势函数但不含 $\sin^3\theta$ 项（Ryckaert-Bellemans型）。 $\phi$ 为二面角。" />
