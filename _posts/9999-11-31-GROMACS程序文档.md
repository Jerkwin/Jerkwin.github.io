...
[gmx pdb2gmx](/GMX/GMXprg#gmx-pdb2gmx--) - 将PDB坐标文件转换为拓扑文件和力场兼容的坐标文件(翻译: 冯佳伟) [原始文档](http://manual.gromacs.org/programs/gmx-pdb2gmx.html) <br>
...
[gmx view](/GMX/GMXprg#gmx-view--) - 在X-Windows终端显示轨迹(翻译: 杨旭云) [原始文档](http://manual.gromacs.org/programs/gmx-view.html)<br>

## 处理能量

[gmx enemat](/GMX/GMXprg#gmx-enemat--) - 从能量文件中提取能量矩阵(翻译: 赵丙春) [原始文档](http://manual.gromacs.org/programs/gmx-enemat.html)<br>
[gmx energy](/GMX/GMXprg#gmx-energy--) - 将能量写入xvg文件并显示平均值(翻译: 姚闯) [原始文档](http://manual.gromacs.org/programs/gmx-energy.html)<br>
...
[gmx sigeps](/GMX/GMXprg#gmx-sigeps--) - 将C6/12或C6/Cn组合转换为sigma/epsilon组合, 或反过来(翻译: 韩广超) [原始文档](http://manual.gromacs.org/programs/gmx-sigeps.html)<br>
...
[gmx xpm2ps](/GMX/GMXprg#gmx-xpm2ps--) - 将XPM(XPixelMap)矩阵转换为postscript或XPM(翻译: 黄丽红) [原始文档](http://manual.gromacs.org/programs/gmx-xpm2ps.html)<br>
...
[gmx pme_error](/GMX/GMXprg#gmx-pme_error--) - 根据给定的输入文件估计使用PME的误差(翻译: 张爱) [原始文档](http://manual.gromacs.org/programs/gmx-pme_error.html)<br>
...
[gmx traj](/GMX/GMXprg#gmx-traj--) - 输出轨迹文件中的坐标x, 速度v, 力f, 盒子, 温度和转动能(翻译: 康文斌) [原始文档](http://manual.gromacs.org/programs/gmx-traj.html)<br>
[gmx tune_pme](/GMX/GMXprg#gmx-tune_pme--) - 计算`mdrun`的运行时间与PME进程数的关系以优化设置(翻译: 嘉晔) [原始文档](http://manual.gromacs.org/programs/gmx-tune_pme.html)<br>
...
[gmx make_ndx](/GMX/GMXprg#gmx-make_ndx--) - 制作索引文件(翻译: 刘恒江) [原始文档](http://manual.gromacs.org/programs/gmx-make_ndx.html)<br>
[gmx mk_angndx](/GMX/GMXprg#gmx-mk_angndx--) - 生成用于gmx angle的索引文件(翻译: 白艳艳) [原始文档](http://manual.gromacs.org/programs/gmx-mk_angndx.html)<br>
...
[gmx confrms](/GMX/GMXprg#gmx-confrms--) - 叠合两个结构并计算RMSD(翻译: 李耀) [原始文档](http://manual.gromacs.org/programs/gmx-confrms.html)<br>
[gmx rms](/GMX/GMXprg#gmx-rms--) - 计算与参考结构之间的RMSD及其矩阵(翻译: 王育伟) [原始文档](http://manual.gromacs.org/programs/gmx-rms.html)<br>
...
[gmx rmsdist](/GMX/GMXprg#gmx-rmsdist--) - 计算-2, -3或-6次平均的原子对距离(翻译: 冯佳伟) [原始文档](http://manual.gromacs.org/programs/gmx-rmsdist.html)<br>
...
[gmx saxs](/GMX/GMXprg#gmx-saxs--) - 计算小角X射线散射谱(翻译: 李继存) [原始文档](http://manual.gromacs.org/programs/gmx-saxs.html)<br>
[gmx traj](/GMX/GMXprg#gmx-traj--) - 输出轨迹文件中的坐标x, 速度v, 力f, 盒子, 温度和转动能(翻译: 康文斌) [原始文档](http://manual.gromacs.org/programs/gmx-traj.html)<br>
[gmx vanhove](/GMX/GMXprg#gmx-vanhove--) - 计算Van Hove位移及相关函数(翻译: 刘恒江) [原始文档](http://manual.gromacs.org/programs/gmx-vanhove.html)<br>
...
[gmx anadock](/GMX/GMXprg#gmx-anadock--) - 根据Autodock运行计算团簇结构(翻译: 白艳艳) [原始文档](http://manual.gromacs.org/programs/gmx-anadock.html)<br>
...
[gmx bar](/GMX/GMXprg#gmx-bar--) - 利用Bennett接受比率方法计算自由能差的估计值(翻译: 陈珂) [原始文档](http://manual.gromacs.org/programs/gmx-bar.html)<br>
...
[gmx do_dssp](/GMX/GMXprg#gmx-do_dssp--) - 指定二级结构并计算溶剂可及表面积(翻译: 杨旭云) [原始文档](http://manual.gromacs.org/programs/gmx-do_dssp.html)<br>
[gmx chi](/GMX/GMXprg#gmx-chi--) - 计算chi和其他二面角的所有信息(翻译: 黄炎) [原始文档](http://manual.gromacs.org/programs/gmx-chi.html) <br>
...
[gmx rama](/GMX/GMXprg#gmx-rama--) - 计算Ramachandran图(翻译: 杜星) [原始文档](http://manual.gromacs.org/programs/gmx-rama.html)<br>
...
[gmx make_edi](/GMX/GMXprg#gmx-make_edi--) - 生成主成分动力学抽样的输入文件(翻译: 严立京) [原始文档](http://manual.gromacs.org/programs/gmx-make_edi.html)<br>

## 简正模式

[gmx anaeig](/GMX/GMXprg#gmx-anaeig--) - 分析简正模式(翻译: 李继存) [原始文档](http://manual.gromacs.org/programs/gmx-anaeig.html)<br>
[gmx nmeig](/GMX/GMXprg#gmx-nmeig--) - 对角化简正模式分析的Hessian矩阵(翻译: 杨旭云) [原始文档](http://manual.gromacs.org/programs/gmx-nmeig.html)<br>
[gmx nmtraj](/GMX/GMXprg#gmx-nmtraj--) - 根据本征向量生成虚拟振荡轨迹(翻译: 王卓亚) [原始文档](http://manual.gromacs.org/programs/gmx-nmtraj.html)<br>
