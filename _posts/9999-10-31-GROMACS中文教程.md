...
+-------------------------------------------------------------------------------------
= 列       = 数据类型   = 字段      = 说明 =
 1 -  6 | Record name | "ATOM  "   |记录类型 Record Type   |
 7 - 11 | Integer     | serial     |原子序号 Atom serial number.  |
13 - 16 | Atom        | name       |原子名称 Atom name.  |
17      | Character   | altLoc     |替代位置 Alternate location indicator.  |
18 - 20 | Residue name| resName    |残基名称 Residue name.  |
22      | Character   | chainID    |原子所属的链 Chain identifier.  |
23 - 26 | Integer     | resSeq     |残基序列号 Residue sequence number.  |
27      | AChar       | iCode      |残基插入代码 Code for insertion of residues.  |
31 - 38 | Real(8.3)   | x          |x坐标 Orthogonal coordinates for X in Angstroms.  |
39 - 46 | Real(8.3)   | y          |y坐标 Orthogonal coordinates for Y in Angstroms.  |
47 - 54 | Real(8.3)   | z          |z坐标 Orthogonal coordinates for Z in Angstroms.  |
55 - 60 | Real(6.2)   | occupancy  |占据因子 Occupancy.  |
61 - 66 | Real(6.2)   | tempFactor |温度因子 Temperature factor.  |
77 - 78 | LString(2)  | element    |元素符号, 右对齐 Element symbol, right-justified.  |
79 - 80 | LString(2)  | charge     |原子电荷 Charge on the atom.  |
+-------------------------+
-->
...
<td colspan="3" style="text-align:left;">原子序号 Atom serial number.</td>
</tr>
<tr>
<td style="text-align:center;">13 - 16</td>
<td style="text-align:center;">Atom</td>
<td style="text-align:center;">name</td>
<td colspan="3" style="text-align:left;">原子名称 Atom name.</td>
</tr>
<tr>
<td style="text-align:left;">17</td>
<td style="text-align:center;">Character</td>
<td style="text-align:center;">altLoc</td>
<td colspan="3" style="text-align:left;">替代位置 Alternate location indicator.</td>
</tr>
<tr>
...
<td colspan="3" style="text-align:left;">占据因子 Occupancy.</td>
</tr>
<tr>
...
<td colspan="3" style="text-align:left;">原子电荷 Charge on the atom.</td>
</tr>
</table>
