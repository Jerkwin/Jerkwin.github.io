...
Prism.languages.fortran = Prism.languages.extend('clike', {
	'comment': /![^\r\n]*(\r?\n|$)/g,
	'keyword': /\b(abs|achar|acos|adjustl|allocatable|allocate|asin|atan|atan2|backspace|blockdata|break|call|case|character|char|close|common|complex|continue|cosh|cos|cycle|dble|data|deallocate|dot_product|do|else|end|End|enddo|exit|exp|external|file|formatted|format|function|Function|getarg|goto|iand|ichar|if|imod|implicit|include|index|inot|integer|int|ior|iostat|len_trim|len|log10|logical|log|malloc|matmul|max|min|module|mod|not|open|parameter|pause|position|print|Program|read|real|Real|return|rewind|save|select|sign|sin|size|sqrt|status|stop|Subroutine|system|tanh|tan|then|transpose|trim|unformatted|unit|use|wait|where|while|write)\b/g,
	'builtin': /\b(Array|TrueClass)\b/,
	'number': /\b-?(0x[\dA-Fa-f]+|\d*\.?\d+([EeDd]-?\d+)?)\b/g
	//'constant': /\b[A-Z][a-zA-Z_0-9]*[?!]?\b/g
});

Prism.languages.insertBefore('fortran', 'keyword', {
	'variable': /[@$]+\b[a-zA-Z_][a-zA-Z_0-9]*[?!]?\b/g,
	'symbol': /:\b[a-zA-Z_][a-zA-Z_0-9]*[?!]?\b/g
});
;
